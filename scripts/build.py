...
CANONICAL_U16_ABILITIES = {
    ...
    'ABILITY_DRAGONIZE',
    'ABILITY_EELEVATE',
    'ABILITY_NEEDLEGRUDGE',
    'ABILITY_MEGASOL',
    'ABILITY_FIREMANE',
    'ABILITY_SILENTGRUDGE',
    'ABILITY_SPICYSPRAY',
    'ABILITY_FUJIN',
    'ABILITY_SONILATE',
    'ABILITY_IMPROVISE',
    ...
    'ABILITY_PHANTOMWALL',
    'ABILITY_VAMPIRE',
    'ABILITY_TRICKROOMENTRY',
    'ABILITY_SUNNYDISPOSITION',
    'ABILITY_SELFMOTIVATION',
    'ABILITY_TEAPARTY',
    'ABILITY_FALLINGCOCONUT',
    'ABILITY_EVILSPIRIT',
    'ABILITY_DESERTSONG',
    'ABILITY_ICECRYSTALPURGE',
}
